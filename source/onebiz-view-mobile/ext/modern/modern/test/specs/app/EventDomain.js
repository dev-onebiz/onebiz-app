topSuite("Ext.app.EventDomain",
    ['Ext.app.*', 'Ext.Component', 'Ext.data.Store', 'Ext.direct.Manager'],
function() {
    ...
    describe("should monitor default base classes for domains:", function() {
        it("Ext.Component for component domain", function() {
            expect(Ext.app.domain.Component.monitoredClasses).toEqual([Ext.Widget]);
        });
    });
});
