topSuite("Ext.dataview.Component", ['Ext.Button'], function() {
    ...
    afterEach(function() {
        view = store = Ext.destroy(view, store);
    ...
    describe("configuring", function() {
        ...
        describe("itemCls", function() {
            function expectCls(item, cls) {
                expect(item.element).toHaveCls(cls);
            }

            function expectNotCls(item, cls) {
                expect(item.element).not.toHaveCls(cls);
            }
    ...
    describe("methods", function() {
        ...
        function expectItem(item, v) {
            expect(item.$className).toBe('spec.MyDataItem');
            expect(item.getHtml()).toBe(v);
        }
