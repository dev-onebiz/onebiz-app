topSuite("Ext.Editor", ['Ext.field.*'], function() {
    ...
    function fireKeyOnField(key) {
        jasmine.fireKeyEvent(field.inputElement, 'keydown', key);
    }

    describe("field creation", function() {
        it("should create a text field by default", function() {
            makeEditor();
            expect(field.$className).toBe('Ext.field.Text');
        });
        ...
        it("should accept a string xtype", function() {
            ...
            expect(field.$className).toBe('Ext.field.Date');
        });
        ...
        it("should accept an object config including xtype", function() {
            ...
            expect(field.$className).toBe('Ext.field.Number');
            expect(field.getMaxValue()).toBe(20);
        });
    });
    ...
    describe("startEdit", function() {
        ...
        describe("positioning", function() {
            it("should align to c-c as the default", function() {
                makeEditor();
                startEditWithTarget();
                expect(editor.element.getXY()).toEqual([0, 0]);
            });
        ...
        describe("events", function() {
            ...
            it("should allow the value to be changed in beforestartedit", function() {
                ...
                expect(editor.getField().getValue()).toBe('blergo');
            });
        });
    });
